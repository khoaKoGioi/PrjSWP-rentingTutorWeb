...
import { FaEnvelope, FaPhone, FaHome, FaBuilding, FaBirthdayCake, FaUser, FaBook, FaInfoCircle } from 'react-icons/fa'
...
const TutorProfile = () => {
  const [user, setUser] = useState({
    ...
    description: 'Experienced in English and Math with over 10 years of teaching'
  })
      ...
      <div className='flex flex-col items-center p-6 bg-white shadow-lg rounded-lg max-w-2xl mx-auto'>
        ...
        <div className='flex items-center w-full mb-4'>
          <div className='w-24 h-24 flex-shrink-0'>
            <img className='rounded-full w-full h-full object-cover' src={user.avatar} alt='User Avatar' />
          </div>
        ...
        <div className='w-full'>
          ...
          <div className='flex items-center mb-4'>
            ...
            <label className='flex-1'>
              <span className='block text-sm font-medium text-gray-700'>Home Address</span>
              <input
                type='text'
                name='homeAddress'
          ...
          <div className='flex items-center mb-4'>
            ...
            <label className='flex-1'>
              <span className='block text-sm font-medium text-gray-700'>List of Subjects</span>
              <input
                type='text'
                name='subjects'
                value={user.subjects}
