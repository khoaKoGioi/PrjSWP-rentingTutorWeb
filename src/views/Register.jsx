  ...
  return (
    <div className='min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8'>
      <div className='sm:mx-auto sm:w-full sm:max-w-md'>
        ...
        <h2 className='text-center text-3xl leading-9 font-extrabold text-gray-900'>Create a new account</h2>
      ...
      <div className='mt-8 sm:mx-auto sm:w-full sm:max-w-md'>
        <div className='bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10'>
          <form method='POST' action='#'>
            ...
            <label
              htmlFor='username'
              className='block text-sm mb-5 mt-6
            ...
            <div>
              <div className='flex flex-row items-center mb-2'>
                <input type='checkbox' id='student' name='student' className='mr-2' />
                <label htmlFor='student' className='text-gray-700'>
                  Student
                </label>
              </div>
              <div className='flex items-center'>
                <input type='checkbox' id='teacher' name='teacher' className='mr-2' />
